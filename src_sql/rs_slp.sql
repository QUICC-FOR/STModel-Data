CREATE MATERIALIZED VIEW rdb_quicc.rs_slp AS (
    SELECT var,  ST_Tile(rast,10,10) AS rast FROM (
             ...
             SELECT 'slp' ::varchar(10) AS var, ST_Transform(ST_Slope(ST_Union(demelevation.rast::raster),1,'32BF'::text,'DEGREES'::text,111120.0::double precision,false),4269) as rast
